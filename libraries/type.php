<?php
	...
	switch($type){
		...
		case 'hethongdoitac':
			...
			break;
		case 'taisao':
			$title_main = "Tại sao chọn chúng tôi";
			$config_images = "true";
			$config_mota= "true";
			$config_list = "false";
			$config_cat = "false";
		...
		case 'logo':
			...
			break;
		case 'logo_right':
			$title_main = 'Logo right';
			@define ( _width_thumb , 204 );
		...
		case 'bg_taisao':
			...
			break;
		case 'bg_menu':
			$title_main = 'Background menu';
			@define ( _width_thumb , 1349 );
			@define ( _height_thumb , 515 );
			@define ( _style_thumb , 1 );
			@define ( _img_type , 'jpg|gif|png|jpeg|PNG|JPG|JPEG|GIF' );
			$ratio_ = 1;
			break;
