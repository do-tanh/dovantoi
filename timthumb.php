...
function check_thumb(){
	$flagThumb=0;
	  $numberPara=count($_GET);
	$StringThumb=explode('/',$_GET['src']);
 	 $falghttp=0;
	 
	 if($StringThumb[2]==$_SERVER['SERVER_NAME']){
	 	   $falghttp=1;
	 }else{
	 	if($StringThumb[0]=="upload"){
	 		 $falghttp=1;
	 	}
	 }
	...
	if(($numberPara==4||$numberPara==5)&&($falghttp==1)&&($_GET['w']>10)){
		$flagThumb=1;
	}
