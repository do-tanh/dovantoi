...
<?php }?>
<script type="application/ld+json">{ "@context": "http://schema.org", "@type": "WebSite", "url": "<?=getCurrentPageURL()?>", "potentialAction": { "@type": "SearchAction", "target": "<?=getCurrentPageURL()?>?s={search_term}", "query-input": "required name=search_term" } }</script>